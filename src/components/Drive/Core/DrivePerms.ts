...
export class DrivePerms {
    ...
    revokePermission(resourceId: string, userId: string) {
        ...
        if (revokedPerm) {
            // Émission de l'événement de révocation
            this.eventSystem.emit('permissionChanged', {
                resourceId,
                userId,
